var app = angular.module('app', ["ngResource", 'ngCookies', 'ngRoute', 'ui.bootstrap', 'ui.select',
 'ngSanitize', 'xeditable', 'toaster', 'ngAnimate', 'textAngular' , 'ngFileUpload', 'NgSwitchery', 'isteven-multi-select']);
...
app.controller('taskHController', function ($scope, taskResource, UserClientResource, $rootScope) {
...
app.controller('configController', function ($scope, UserClientResource, $rootScope, usersResource, $injector, $timeout, configurationResource) {
  ...
  $scope.moveItem = function(item, from, to, mode) {
    ...
    if(mode==="add") {
      ...
      UserClientResource.delete({ id : item.id });
      $timeout(600, getYrel());
    }
  };
  
  getNrel = function() {
    usersResource.query({ ne : $rootScope.userId }, function(data){
      $scope.relNo = data;
  ...
  /*configurationResource.get({ id : $rootScope.userId }, function(data){
